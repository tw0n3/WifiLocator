...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table "+TB_Name + " ( "+COL_1+" TEXT PRIMARY KEY,"+COL_2+" TEXT,"+COL_3+" TEXT,"+COL_4+" TEXT)");
    }

    public boolean insertData(String RPID, String RSSI_1, String RSSI_2, String RSSI_3){
